...
public class CellarUtils {
     ...
     *
     * @param text the comma delimited String.
    ...
    /**
     * Create a comma delimited list of items.
     *
     * @param items the set of items to assemble.
     * @param mergable true to create a merge-able String, false else.
     * @return the resulting comma delimited String.
     */
    ...
    /**
     * Check if two collections are equals.
     *
     * @param col1 the first collection.
     * @param col2 the second collection.
     * @return true if the two collections are equals, false else.
     */
    ...
    /**
     * Check if a collection is a subset of another one.
     *
     * @param source the source collection.
     * @param target the target collection.
     * @return true if source collection is a subset of the target one, false else.
     */
